Vector Analyzer is a website that analyzes 2D vectors and simulate their effect in motion. The website has two 
main features: Motion Simulator and X-Y Components Calculator. The Motion Simulator uses user input to draw the 
final vector and simulate the motion on an object, simulating its acceleration. The X-Y Component Calculator 
